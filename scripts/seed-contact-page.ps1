...
$document = @{
  ...
  sections = @(
    ...
    @{ _key = "contact-form"; _type = "contactFormSection"; heading = "Get in Touch"; body = "Have an enquiry? Please fill the form below and our team will get back to you soon."; firstNameLabel = "Name"; emailLabel = "Email Address"; phoneLabel = "Phone Number"; messageLabel = "Ask Us Anything"; attachmentLabel = "Attach a photo"; attachmentHelp = "Optional. JPG, PNG, WEBP or HEIC, up to 4MB."; removeAttachmentLabel = "Remove attachment"; submitLabel = "Submit"; successMessage = "Thank you. Your message has been received and our team will contact you shortly."; errorMessage = "Your message could not be sent. Please check the form and try again." }
  )
}
