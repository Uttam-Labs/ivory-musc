...
const editorialImage = await image(resolve("public/figma/silk-editorial-dusty-rose.png"), "Dusty rose mulberry silk folds");
const understandingImage = await image(resolve("public/figma/silk-understanding-sage.png"), "Pale sage mulberry silk folds");
const guideImage = await image(resolve("public/figma/silk-guide-floral-banner-hq.png"), "Floral silk fabric detail");
...
const document = {
  ...
  sectionVisibility: { hero:true, introduction:true, art:true, understanding:true, fabrics:false, finder:true, detailedGuide:true, cta:true },
