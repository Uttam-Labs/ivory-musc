...
export const NEWSLETTER_POPUP_QUERY = defineQuery(`*[_id == "waitlistPage"][0]{backgroundImage{...,alt,"assetUrl":asset->url},formHeading,confirmationText,emailLabel,emailPlaceholder,submitLabel,submittingLabel,consentText,alreadySubscribedMessage,fallbackErrorMessage}`);
