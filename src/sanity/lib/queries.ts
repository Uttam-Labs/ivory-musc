...
export const HOME_NEWSLETTER_QUERY = defineQuery(`*[_id == "homePage"][0].sections[_type == "newsletter"][0]{heading,body,emailLabel,emailPlaceholder,submitLabel,submittingLabel,successMessage,alreadySubscribedMessage,fallbackErrorMessage}`);
