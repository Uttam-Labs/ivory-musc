...
export const HEADER_SETTINGS_QUERY = defineQuery(`*[_id == "headerSettings"][0]{title, logo, logoSizeDesktop, logoSizeMobile, navigation[]{label, href, isVisible}, showSearch, searchHref, showAccount, accountHref, showCart, cartHref}`);
...
export const SILK_GUIDE_PAGE_QUERY = defineQuery(`*[_id == "silkGuidePage" && _type == "silkGuidePage"][0]{_updatedAt,title,seoTitle,seoDescription,hero{...,image{...,alt}},introduction,art{...,image{...,alt}},understanding{...,image{...,alt},characteristics[]{...}},fabricsHeading,fabricsIntroduction,fabrics[]{...},finder{...,cards[]{...}},guideImage{...,alt},guideSections[]{...},cta}`);
