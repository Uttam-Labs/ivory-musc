...
export const accountDashboardPage = defineType({
  ...
  fields: [
    ...
    text("accountHeading", "Fallback account heading"),
    text("supportKicker", "Support card eyebrow"),
    text("singleOrderLabel", "Single recent order label"),
    text("multipleOrdersLabel", "Multiple recent orders label"),
    text("ordersCountLabel", "Orders count accessibility label"),
    text("addressesCountLabel", "Addresses count accessibility label"),
    text("errorTitle", "Account loading error heading"),
    text("errorMessage", "Account loading error message"),
    text("retryLabel", "Retry button label"),
    text("feedbackErrorHeading", "Error notification heading"),
    text("feedbackSuccessHeading", "Success notification heading"),
    text("feedbackDismissLabel", "Dismiss notification accessibility label"),
  ],
});
...
export const accountProfilePage = defineType({
  ...
  fields: [
    ...
    text("confirmTitle", "Confirmation dialog heading"),
    text("confirmLabel", "Confirmation button label"),
    text("cancelLabel", "Confirmation cancel label"),
    text("passwordMismatchMessage", "Password mismatch message"),
    text("errorTitle", "Profile loading error heading"),
    text("errorMessage", "Profile loading error message"),
    text("retryLabel", "Retry button label"),
    text("feedbackErrorHeading", "Error notification heading"),
    text("feedbackSuccessHeading", "Success notification heading"),
    text("feedbackDismissLabel", "Dismiss notification accessibility label"),
...
export const accountOrdersPage = defineType({
  ...
  initialValue: {
    ...
    errorText: "Please refresh the page and try again.",
    retryLabel: "Try again",
  },
  fields: [
    text("seoTitle", "SEO title"),
    ...
    text("filterAll", "All orders filter"),
    text("filterOpen", "Open orders filter"),
    text("filterFulfilled", "Fulfilled filter"),
    text("filterCancelled", "Cancelled filter"),
    text("noResultsHeading", "No results heading"),
    text("noResultsText", "No results description"),
    text("viewDetailsLabel", "View details label"),
    text("previousLabel", "Previous page label"),
    text("nextLabel", "Next page label"),
    text("filterLabel", "Order filter accessibility label"),
    text("cancelledLabel", "Cancelled status label"),
    text("paginationLabel", "Pagination accessibility label"),
    text("errorHeading", "Orders loading error heading"),
    text("errorText", "Orders loading error message"),
    text("retryLabel", "Retry button label"),
  ],
});
...
export const accountOrderDetailsPage = defineType({
  ...
  initialValue: {
    ...
    itemsHeading: "Items in your order",
    skuLabel: "SKU",
    ...
    trackingHeading: "Delivery & tracking",
    trackPackageLabel: "Track package",
    trackingPendingText: "Tracking details will appear here as soon as your order has shipped.",
    ...
    errorMessage: "The order details are temporarily unavailable. Your account is still signed in. Please try again.",
    retryLabel: "Try again",
  },
  fields: [
    ...
    text("itemsHeading", "Order items heading"),
    text("skuLabel", "SKU label"),
    text("refundedLabel", "Refunded label"),
    text("progressHeading", "Progress heading"),
    text("placedLabel", "Order placed step"),
    text("paidLabel", "Payment confirmed step"),
    text("preparingLabel", "Preparing order step"),
    text("fulfilledLabel", "Fulfilled step"),
    text("trackingHeading", "Tracking heading"),
    text("trackPackageLabel", "Track package link"),
    text("trackingPendingText", "Tracking pending message"),
    text("contactHeading", "Contact heading"),
    text("contactLabel", "Contact label"),
    text("phoneLabel", "Phone label"),
    text("orderDateLabel", "Order date label"),
    ...
    text("cancelledBadgeLabel", "Cancelled status badge"),
    text("paymentMethodLabel", "Payment method label"),
    text("paymentCardLabel", "Payment card label"),
    text("paymentProviderLabel", "Payment provider label"),
    text("paymentStatusLabel", "Payment status label"),
    text("paymentAmountLabel", "Payment amount label"),
    text("carrierLabel", "Fallback shipping carrier label"),
    text("errorTitle", "Order loading error heading"),
    text("errorMessage", "Order loading error message"),
    text("retryLabel", "Retry button label"),
  ],
});
...
export const accountAddressesPage = defineType({
  ...
  fields: [
    ...
    text("confirmTitle", "Confirmation dialog heading"),
    text("confirmLabel", "Confirmation button label"),
    text("confirmCancelLabel", "Confirmation cancel label"),
    text("errorTitle", "Addresses loading error heading"),
    text("errorMessage", "Addresses loading error message"),
    text("retryLabel", "Retry button label"),
    text("feedbackErrorHeading", "Error notification heading"),
    text("feedbackSuccessHeading", "Success notification heading"),
    text("feedbackDismissLabel", "Dismiss notification accessibility label"),
