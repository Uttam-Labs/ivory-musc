      ...
      of: [
        defineArrayMember({
          ...
          fields: [
            ...
            defineField({ name: "sampleStandardShippingText", title: "Standard sample shipping", type: "string", initialValue: "Standard sample shipping: $6 · 2–6 business days" }),
            defineField({ name: "sampleExpressShippingText", title: "Express sample shipping", type: "string", initialValue: "Express sample shipping: $12 · 1–3 business days" }),
