      ...
      of: [
        defineArrayMember({
          ...
          fields: [
            ...
            defineField({ name: "decreaseQuantityLabel", title: "Decrease quantity accessibility label", type: "string", initialValue: "Decrease quantity" }),
            defineField({ name: "increaseQuantityLabel", title: "Increase quantity accessibility label", type: "string", initialValue: "Increase quantity" }),
            defineField({ name: "closeZoomLabel", title: "Close zoom accessibility label", type: "string", initialValue: "Close zoom view" }),
            defineField({ name: "previousImageLabel", title: "Previous image accessibility label", type: "string", initialValue: "Previous product image" }),
            defineField({ name: "nextImageLabel", title: "Next image accessibility label", type: "string", initialValue: "Next product image" }),
            defineField({ name: "viewImageLabel", title: "View image accessibility label", type: "string", initialValue: "View image" }),
