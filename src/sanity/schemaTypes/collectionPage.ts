  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: "quickViewLabel", title: "Quick-view accessibility label", type: "string", initialValue: "Quick view" }),
        defineField({ name: "closeQuickViewLabel", title: "Close quick-view accessibility label", type: "string", initialValue: "Close quick view" }),
        ...
        defineField({ name: "productImageAlt", title: "Fallback product image alt text", type: "string", initialValue: "Product view" }),
        defineField({ name: "actionErrorText", title: "Cart fallback error", type: "string", initialValue: "Please try again" }),
      ],
    }),
  ],
  preview: {
