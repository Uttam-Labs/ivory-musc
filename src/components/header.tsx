...
import { cartVariantDetails, formatCartAttributeValue } from "@/lib/shopify/cart-display";
...
export function Header({
  ...
  const lightHeaderAtTop = !overlaysHero && !headerScrolled;
  const iconClass = `inline-flex size-9 items-center justify-center rounded-full transition duration-300 focus-visible:outline focus-visible:outline-1 focus-visible:outline-offset-2 ${
    lightHeaderAtTop ? "hover:bg-black/5" : "hover:bg-white/15"
  }`;
          ...
          <div className="flex-1 overflow-y-auto px-7 py-7">
            {cartLoading ? (
              ...
              <div className="flex h-full flex-col items-center justify-center text-center">
                ...
                <p className="mt-9 font-heading text-xl">{copy.emptyCartText}</p>
                <Link
