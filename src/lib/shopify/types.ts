...
export type Cart = {
  ...
  lines: { nodes: Array<{ id: string; quantity: number; attributes: Array<{ key: string; value: string }>; cost: { amountPerQuantity: Money; totalAmount: Money }; merchandise: { id: string; title: string; selectedOptions: SelectedOption[]; product: Pick<Product, "handle" | "title">; image: ShopifyImage | null; price: Money; compareAtPrice: Money | null } }> };
};
